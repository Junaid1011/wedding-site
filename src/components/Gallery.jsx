...
const images = [
    { src: "/gallery-1.jpg", alt: "Couple Photo 1", className: "md:col-span-2 md:row-span-2", imgClass: "object-center" },
    ...
    { src: "/gallery-4.jpg", alt: "Couple Photo 4", className: "md:col-span-1 md:row-span-1", imgClass: "object-center" },
    { src: "/gallery-5.jpg", alt: "Couple Photo 5", className: "md:col-span-1 md:row-span-1", imgClass: "object-top" },
